...
import { addGroup } from '../Pages/Settings/groupsSlicer';
...
const projectsOptions = projects.map(project =>({
 ...
 value: project.id,
  ...
  return (
    ...
    form={form}
  >
    <Form.Item name='groupName' label="Group title"  tooltip="it must be unique title" rules={[{ required: true, message: 'Please group title' }]}>
      <Input />
    </Form.Item>
   ...
   <Form.Item name='groupAllowedProjects'  label="Add projects"  >
    ...
    {/* <Form.Item label="Gender" name="GroupRadio">
          <Radio.Group>
